...
public class CommunityLogin extends javax.swing.JFrame {
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        String mail="sonureddy106@gmail.com";
        String pwd="sonureddy";
        ...
        if (communityEmail.getText().isEmpty() | communityPass.getPassword().length==0){
            ...
            if(cpass.equals("sonureddy") && cemail.equals("sonureddy106@gmail.com")){
                
             JOptionPane.showMessageDialog(this, "Login Successfull", "Warning", JOptionPane.ERROR_MESSAGE);
             CommunityLogin cl = new CommunityLogin();
            ...
            for(Community com : CommunityDirectory.arrayReturn()){
               if ( cemail.equals(mail)&& cpass.equals(pwd)) {
                    loginUser = true;
