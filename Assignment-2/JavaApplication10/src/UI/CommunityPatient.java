 ...
 * @author Sonur
 */
public class CommunityPatient extends javax.swing.JFrame {
    /**
     * Creates new form ViewPatient
     */
    public CommunityPatient() {
        initComponents();
       update();
    }
    ...
    private void initComponents() {
        ...
        viewPatientTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Gender", "Age", "Contact", "Community"
            }
        ));
  ...
  CommunityMain cm = new CommunityMain();
    ...
    public void update(){
      ...
      DefaultTableModel tableModel = (DefaultTableModel) viewPatientTable.getModel();
        ...
        ArrayList<Patients> patient = PatientDirectory.arrayValueReturn();
        ...
        for(int i=0 ; i< PatientDirectory.arrayListLength();i++){
            ...
            Object[] rowData = new Object[]{
                ...
                patient.get(i).name,   
                patient.get(i).email, 
                patient.get(i).gender,
                patient.get(i).age,                
                patient.get(i).contact,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CommunityPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CommunityPatient().setVisible(true);
